...
export default function AuthForm({ onSendCode, onVerifyCode }: Props) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <p className="mt-auto pt-4 text-[11px] text-white/30">Sessions last 24 hours, then you sign in again.</p>
    </div>
  );
}