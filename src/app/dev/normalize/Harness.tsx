...
/**
 * /dev/normalize harness UI for src/lib/imageNormalize.ts (see page.tsx for
 ...
 * desktop Chrome/Firefox to exercise the lazy WASM HEIC path, or open a
 * preview deploy on a phone to test real camera output, without going
 * through the DM flow.
 */
